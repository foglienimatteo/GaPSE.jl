...
@testset "test print_map_sum_ξ_GNC_multipole no_window with obs, first method" begin
     ...
     @testset "L = 0 no_window" begin
          ...
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_quad_noF_specific_ss.txt", comments=true)

          name = "calc_xis_GNC_L$L" * "_quad_noF_specific_ss.txt"
          isfile(name) && rm(name)
          ...
          ss_trap, res_sums_trap, res_xis_trap = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_trap_noF_specific_ss.txt", comments=true)
          ...
          ss_lob, res_sums_lob, res_xis_lob = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_lob_noF_specific_ss.txt", comments=true)
...
@testset "test print_map_sum_ξ_GNC_multipole with_window with obs, first method" begin
     RTOL = 1.2e-2
     ...
     @testset "L = 0 with_window" begin
          ...
          ##### quad ####
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_quad_withF_specific_ss.txt", comments=true)

          name = "calc_xis_GNC_L$L" * "_quad_withF_specific_ss.txt"
          isfile(name) && rm(name)
          ...
          #### trap ####
          ss_trap, res_sums_trap, res_xis_trap = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_trap_withF_specific_ss.txt", comments=true)
          ...
          #### lob ####
          ss_lob, res_sums_lob, res_xis_lob = GaPSE.readxyall(
               "datatest/GNC_SumXiMultipoles/xis_GNC_L$L" * "_lob_withF_specific_ss.txt", comments=true)
...
@testset "test print_map_sum_ξ_GNC_multipole with_window with obs, second method" begin
     RTOL = 1.2e-2
