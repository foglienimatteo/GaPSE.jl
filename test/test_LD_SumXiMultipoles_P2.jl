...
println("\nNow I work on print_map_sum_ξ_LD_multipole.")
println("This will be longer...")


@testset "test print_map_sum_ξ_LD_multipole no_window, first method" begin
     RTOL = 1.2e-2
     ...
     @testset "test_zeros" begin
          @test_throws AssertionError GaPSE.GaPSE.print_map_sum_ξ_LD_multipole(COSMO, "NONEXISTINGDIR/file.txt", [1.0, 2.0, 3.0])
     end
     ...
     @testset "L = 0 no_window" begin
          ...
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/LD_SumXiMultipoles/xis_LD_L$L" * "_quad_noF_specific_ss.txt", comments=true)

          name = "calc_xis_LD_L$L" * "_quad_noF_specific_ss.txt"
          isfile(name) && rm(name)

          GaPSE.print_map_sum_ξ_LD_multipole(COSMO, name, ss_quad; 
...
@testset "test print_map_sum_ξ_LD_multipole with_window, first method" begin
     RTOL = 1.2e-2
     ...
     @testset "L = 0 with_window" begin
          ...
          ##### quad ####
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/LD_SumXiMultipoles/xis_LD_L$L" * "_quad_withF_specific_ss.txt", comments=true)
...
@testset "test print_map_sum_ξ_LD_multipole no_window second method" begin
     RTOL = 1.2e-2
     ...
     @testset "L = 0 no_window" begin
          ...
          calc_xis_quad = [
               begin
                    a_name = "all_LD_standalones_CFs/xi_LD_" * effect * "_L$L" * ".txt"
