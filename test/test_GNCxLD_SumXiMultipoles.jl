...
@testset "test sum_ξ_GNCxLD_multipole no_window" begin
     ...
     @testset "L = 0 no_window" begin
          ...
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/GNCxLD_SumXiMultipoles/map_sum_xi_GNCxLD_L$L" * "_quad_noF_specific_ss.txt", comments=true)
          ss_trap, res_sums_trap, res_xis_trap = GaPSE.readxyall(
               "datatest/GNCxLD_SumXiMultipoles/map_sum_xi_GNCxLD_L$L" * "_trap_noF_specific_ss.txt", comments=true)
...
@testset "test sum_ξ_GNCxLD_multipole with_window" begin
     ...
     @testset "L = 0 with_window" begin
          L = 0
          ss_quad, res_sums_quad, res_xis_quad = GaPSE.readxyall(
               "datatest/GNCxLD_SumXiMultipoles/map_sum_xi_GNCxLD_L$L" * "_quad_withF_specific_ss.txt", comments=true)
          ss_trap, res_sums_trap, res_xis_trap = GaPSE.readxyall(
               "datatest/GNCxLD_SumXiMultipoles/map_sum_xi_GNCxLD_L$L" * "_trap_withF_specific_ss.txt", comments=true)
          ss_lob, res_sums_lob, res_xis_lob = GaPSE.readxyall(
