...
@testset "test xi newton_localgp L = 0 no observer terms" begin
    effect = "newton_localgp"
    L = 0
...
@testset "test xi newton_localgp L = 0 no observer velocity terms" begin
    effect = "newton_localgp"
    L = 0
...
@testset "test xi newton_localgp L = 0 with observer terms" begin
    effect = "newton_localgp"
    L = 0
...
@testset "test xi localgp_newton L = 0 no observer terms" begin
    effect = "localgp_newton"
    L = 0
...
@testset "test xi localgp_newton L = 0 no observer velocity terms" begin
    effect = "localgp_newton"
    L = 0
...
@testset "test xi localgp_newton L = 0 with observer terms" begin
    effect = "localgp_newton"
    L = 0
