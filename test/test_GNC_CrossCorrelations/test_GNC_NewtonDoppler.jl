...
@testset "test xi newton_doppler L = 0 no observer terms" begin
...
@testset "test xi newton_doppler L = 0 no observer velocity terms" begin
    effect = "newton_doppler"
    L = 0
...
@testset "test xi newton_doppler L = 0 with observer terms" begin
    effect = "newton_doppler"
    L = 0
...
@testset "test xi doppler_newton L = 0 no observer terms" begin
...
@testset "test xi doppler_newton L = 0 no observer velocity terms" begin
    effect = "doppler_newton"
    L = 0
...
@testset "test xi doppler_newton L = 0 with observer terms" begin
    effect = "doppler_newton"
    L = 0
