...
@testset "test xi lensing_integratedgp L = 0 no observer terms" begin
...
@testset "test xi lensing_integratedgp L = 0 no observer velocity terms" begin
    effect = "lensing_integratedgp"
    L = 0
...
@testset "test xi lensing_integratedgp L = 0 with observer terms" begin
    effect = "lensing_integratedgp"
    L = 0
...
@testset "test xi integratedgp_lensing L = 0 no observer terms" begin
...
@testset "test xi integratedgp_lensing L = 0 no observer velocity terms" begin
    effect = "integratedgp_lensing"
    L = 0
...
@testset "test xi integratedgp_lensing L = 0 with observer terms" begin
    effect = "integratedgp_lensing"
    L = 0
