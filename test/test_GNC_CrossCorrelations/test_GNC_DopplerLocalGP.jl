...
@testset "test xi doppler_localgp L = 0 no observer terms" begin
     effect = "doppler_localgp"
     L = 0
...
@testset "test xi doppler_localgp L = 0 no observer velocity terms" begin
     effect = "doppler_localgp"
     L = 0
...
@testset "test xi doppler_localgp L = 0 with observer terms" begin
     effect = "doppler_localgp"
     L = 0
...
@testset "test xi localgp_doppler L = 0 no observer terms" begin
...
@testset "test xi localgp_doppler L = 0 no observer velocity terms" begin
     effect = "localgp_doppler"
     L = 0
...
@testset "test xi localgp_doppler L = 0 with observer terms" begin
     effect = "localgp_doppler"
     L = 0
