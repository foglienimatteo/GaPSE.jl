...
@testset "test xi doppler_lensing L = 0 no observer terms" begin
...
@testset "test xi doppler_lensing L = 0 no observer velocity terms" begin
    effect = "doppler_lensing"
    L = 0
...
@testset "test xi doppler_lensing L = 0 with observer terms" begin
    effect = "doppler_lensing"
    L = 0
...
@testset "test xi lensing_doppler L = 0 no observer terms" begin
...
@testset "test xi lensing_doppler L = 0 no observer velocity terms" begin
    effect = "lensing_doppler"
    L = 0
...
@testset "test xi lensing_doppler L = 0 with observer terms" begin
    effect = "lensing_doppler"
    L = 0
