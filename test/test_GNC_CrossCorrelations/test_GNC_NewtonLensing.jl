...
@testset "test xi newton_lensing L = 0 no observer terms" begin
...
@testset "test xi newton_lensing L = 0 no observer velocity terms" begin
     effect = "newton_lensing"
     L = 0
...
@testset "test xi lensing_newton L = 0 no observer terms" begin
...
@testset "test xi lensing_newton L = 0 no observer velocity terms" begin
     effect = "lensing_newton"
     L = 0
...
@testset "test xi lensing_newton L = 0 with observer terms" begin
     effect = "lensing_newton"
     L = 0
