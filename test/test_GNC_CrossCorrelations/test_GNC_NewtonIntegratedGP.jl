...
@testset "test xi newton_integratedgp L = 0 no observer terms" begin
    effect = "newton_integratedgp"
    L = 0
...
@testset "test xi newton_integratedgp L = 0 no observer velocity terms" begin
    effect = "newton_integratedgp"
    L = 0
...
@testset "test xi newton_integratedgp L = 0 with observer terms" begin
    effect = "newton_integratedgp"
    L = 0
...
@testset "test xi integratedgp_newton L = 0 no observer terms" begin
    effect = "integratedgp_newton"
    L = 0
...
@testset "test xi integratedgp_newton L = 0 no observer velocity terms" begin
    effect = "integratedgp_newton"
    L = 0
...
@testset "test xi integratedgp_newton L = 0 with observer terms" begin
    effect = "integratedgp_newton"
    L = 0
