...
@testset "test xi doppler_integratedgp L = 0 no observer terms" begin
...
@testset "test xi doppler_integratedgp L = 0 no observer velocity terms" begin
     effect = "doppler_integratedgp"
     L = 0
...
@testset "test xi doppler_integratedgp L = 0 with observer terms" begin
     effect = "doppler_integratedgp"
     L = 0
...
@testset "test xi integratedgp_doppler L = 0 no observer terms" begin
...
@testset "test xi integratedgp_doppler L = 0 no observer velocity terms" begin
     effect = "integratedgp_doppler"
     L = 0
...
@testset "test xi integratedgp_doppler L = 0 with observer terms" begin
     effect = "integratedgp_doppler"
     L = 0
