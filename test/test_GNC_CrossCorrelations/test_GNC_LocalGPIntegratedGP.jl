...
@testset "test xi localgp_integratedgp L = 0 no observer terms" begin
...
@testset "test xi localgp_integratedgp L = 0 no observer velocity terms" begin
    effect = "localgp_integratedgp"
    L = 0
...
@testset "test xi localgp_integratedgp L = 0 with observer terms" begin
    effect = "localgp_integratedgp"
    L = 0
...
@testset "test xi integratedgp_localgp L = 0 no observer terms" begin
...
@testset "test xi integratedgp_localgp L = 0 no observer velocity terms" begin
    effect = "integratedgp_localgp"
    L = 0
...
@testset "test xi integratedgp_localgp L = 0 with observer terms" begin
    effect = "integratedgp_localgp"
    L = 0
