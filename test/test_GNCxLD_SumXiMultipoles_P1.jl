...
println("\n\nNow I start the tests of sum_ξ_GNCxLD_multipole and map_sum_ξ_GNCxLD_multipole")
    ...
    @testset "L = 0 no_window" begin
        ...
        @testset "s = 10, L = 0, no_window" begin
            ...
            calc_res_sum_spec_ss_quad, calc_res_xis_spec_ss_quad =
                GaPSE.sum_ξ_GNCxLD_multipole(COSMO.s_eff, s, COSMO; L=L, alg=:quad, kwargs...)
            ...
            calc_res_sum_spec_ss_trap, calc_res_xis_spec_ss_trap =
                GaPSE.sum_ξ_GNCxLD_multipole(COSMO.s_eff, s, COSMO; L=L, alg=:trap, kwargs...)
            ...
            calc_res_sum_spec_ss_lob, calc_res_xis_spec_ss_lob =
                GaPSE.sum_ξ_GNCxLD_multipole(COSMO.s_eff, s, COSMO; L=L, alg=:lobatto, kwargs...)
...
@testset "test map_sum_ξ_GNCxLD_multipole no_window" begin
    ...
    @testset "L = 0 no_window" begin
        ...
        calc_ss_quad, calc_sums_quad, calc_xis_quad = GaPSE.map_sum_ξ_GNCxLD_multipole(COSMO, ss_quad;
            L=L, alg=:quad, kwargs...)
        ...
        calc_ss_trap, calc_sums_trap, calc_xis_trap = GaPSE.map_sum_ξ_GNCxLD_multipole(COSMO, ss_trap;
            L=L, alg=:trap, kwargs...)
...
println("\nJust finished the tests on map_sum_ξ_GNCxLD_multipole!")
