...
@testset "test xi auto_newton L = 0 no observer terms" begin
    effect = "auto_newton"
    L = 0
...
@testset "test xi auto_newton L = 0 no observer velocity terms" begin
    effect = "auto_newton"
    L = 0
...
@testset "test xi auto_newton L = 0 with observer terms" begin
    effect = "auto_newton"
    L = 0
