...
In the former method you have to pass as an input the GNC `effect` function you want 
...
- `effect::Function` or `effect::String` : name/function you want to consider, among the ones
  inside `GaPSE.GR_EFFECTS_GNC`/`GaPSE.VEC_ξs_GNC` respectively.
...
- `kwargs...` : other keyword arguments that will be passed to the selected 
  GNC TPCF effect (`ξ_GNC_Doppler`, `ξ_GNC_Lensing`, ...)
...
[`y`](@ref), [`s2`](@ref), [`GR_EFFECTS_GNC`](@ref), [`VEC_ξs_GNC`](@ref)
"""
ξ_GNC_multipole
