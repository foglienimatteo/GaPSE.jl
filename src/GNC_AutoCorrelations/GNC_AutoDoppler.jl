...
function ξ_GNC_Doppler(P1::Point, P2::Point, y, cosmo::Cosmology; obs::Bool = true)
     ...
     if obs == false
          ...
          obs_common_12 = y * f0 * ℋ0 * s1^2 * f1 * ℛ1 * (ℛ2 - 5 * s_b2 + 2)
          obs_common_21 = y * f0 * ℋ0 * s2^2 * f2 * ℛ2 * (ℛ1 - 5 * s_b1 + 2)
          J_σ2 = 1 / 3 * y * f0^2 * ℋ0^2 * (ℛ1 - 5 * s_b1 + 2) * (ℛ2 - 5 * s_b2 + 2)

          obs_terms_12 = D1 * obs_common_12 * (1 / 5 * ℋ1 * (I11_s1 + I31_s1) - I13_s1 )
          obs_terms_21 = D2 * obs_common_21 * (1 / 5 * ℋ2 * (I11_s2 + I31_s2) - I13_s2 )
