...
# ╔═╡ 86804d60-7957-11ec-2b7c-33fde3e73790
begin
	using Dierckx
	using Plots
...
m = readdlm("src/F_map_stable_2.txt", comments=true)
...
# ╔═╡ bb66f40c-4e95-48dc-99dd-dc149f4e05e3
surface(xs, μs, Fs, c=cgrad([:yellow, :red]), size=(400,300), camera=(70, 30))
